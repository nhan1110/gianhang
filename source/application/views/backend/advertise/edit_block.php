...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>Advertise edit block show &nbsp;&nbsp;&nbsp; <a href="<?php echo base_url("admin/advertises/add_block");?>" class="btn btn-primary" title="Thêm mới"><i class="fa fa-plus-circle"></i> Add new</a></h1>
        <ol class="breadcrumb">
                    ...
                    <div class="box-body">
                        <form action="" method="post" enctype="multipart/form-data">
                            <div class="form-group">
                                <label>Title*:</label>
                                <input type="text" value="<?php echo @$record['Title'] ;?>" name="title" class="form-control required" placeholder="Title">
