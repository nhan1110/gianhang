        ...
        <div class="row">
            <div class="col-lg-8 col-md-12">
                <div class="box">
                    ...
                    <div class="box-body">
                        <table class="table table-bordered" id="data-grid">
                            ...
                            <?php if (isset($collections) && count($collections) > 0) : 
                                ...
                                <tr class="row-item">
                                    <td><?php echo $i;?>.</td>
                                    <td class="title"><?php echo $item->Group_Title; ?></td>
                                    <td class="description"><?php echo $item->Group_Description; ?></td>
                                    <td class="action">
                                        <a class="edit" title="Edit" data-id="<?php echo $item->ID; ?>" href="javascript:;"><i class="fa fa-edit"></i></a>&nbsp;
                                		
                                        <a class="delete" title="Delete" data-id="<?php echo $item->ID; ?>" href="<?php echo base_url('admin/members_group/delete/' . $item->ID); ?>" onclick="return confirm('Do you want to delete');"><i class="fa fa-close"></i></a>
                                    </td>
                                </tr>
                                <?php
                                endforeach;
                    ...
                    <div class="box-footer clearfix">
                        <?php echo paging($total_rows, $per_page, site_url("admin/members_group/index"), $current_page, $show_number_page); ?>
                    </div>
                </div><!-- /.box -->
            </div>
            <div class="col-lg-4 col-sm-12">
                <div class="box box-primary">
                    ...
                    <!-- form start -->
                    <form role="form" action="<?php echo base_url('admin/members_group/index/' . $current_page); ?>" name="form" id="form" method="POST">
                        <div class="box-body">
