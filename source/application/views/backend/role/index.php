        ...
        <div class="row">
            <div class="col-lg-8 col-md-12">
                <div class="box">
                            ...
                            <?php if (isset($collections) && count($collections) > 0) : 
                                ...
                                <tr class="row-item">
                                    ...
                                    <td class="action">
                                		...
                                		<a class="rule" title="Rule" data-id="<?php echo $item->ID; ?>" href="<?php echo site_url('admin/role/setrule/?id='.$item->ID); ?>"><i class="fa fa-user-plus"></i></a>&nbsp;
                                        <a class="delete" title="Delete" data-id="<?php echo $item->ID; ?>" href="<?php echo base_url('admin/role/delete/' . $item->ID); ?>" onclick="return confirm('Do you want to delete');"><i class="fa fa-close"></i></a>
                                    </td>
                                </tr>
                                <?php
                                endforeach;
                    ...
                    <div class="box-footer clearfix">
                        <?php echo paging($total_rows, $per_page, site_url("admin/role/index"), $current_page, $show_number_page); ?>
                    </div>
                </div><!-- /.box -->
            </div>
            <div class="col-lg-4 col-sm-12">
                <div class="box box-primary">
                    ...
                    <!-- form start -->
                    <form role="form" action="<?php echo base_url('admin/role/index/' . $current_page); ?>" name="form" id="form" method="POST">
                        <div class="box-body">
