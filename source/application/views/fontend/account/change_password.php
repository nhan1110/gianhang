			      ...
			      <div class="panel-body">
			         <div class="text-center">
			            ...
			            <div class="panel-body">
							...
							<?php else: ?>
				                <form class="form" method="post" action="<?php echo base_url('/tai-khoan/thay-doi-mat-khau/'); ?>">
				                  	<fieldset>
					                    ...
					                    <div class="form-group">
					                        <input class="btn btn-lg btn-primary btn-block" value="Đổi mật khẩu" type="submit">
					                    </div>
				                  	</fieldset>
				                </form>
			                <?php endif; ?>
