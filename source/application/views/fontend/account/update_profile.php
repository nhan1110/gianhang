...
<div class="container" style="background: #fff;padding: 30px 0;border-bottom: 1px solid #ccc;">
	<div class="row">
		<div class="col-md-10 col-sm-12 col-md-push-1 col-md-pull-1">
					    ...
					    <div class="row">
					    	...
					    	<div class="col-md-9">
					    		<div class="form-group row">
					               <label class="col-sm-2 control-label">Họ đệm:</label>
					               <div class="col-sm-10">
